...
tf.app.flags.DEFINE_float('gradient_range', 1e-4, 'The range of gradient.')
...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        with tf.device(deploy_config.inputs_device()):
            ...
            # Clip gradient
            clones_gradients, var = zip(*clones_gradients)
            clones_gradients_clipped, _ = tf.clip_by_global_norm(clones_gradients,
                                                                 FLAGS.gradient_range)
            clones_gradients = zip(clones_gradients_clipped, var)
